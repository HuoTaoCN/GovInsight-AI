      ...
      <header className="bg-slate-900 text-white p-4 shadow-md shrink-0 z-10">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight hidden md:block">GovInsight-AI 热线工单质量智能检测系统 <span className="text-xs font-normal text-slate-500 bg-slate-800 px-1.5 py-0.5 rounded ml-2">V0.4.0</span></h1>
              <h1 className="text-lg font-bold tracking-tight md:hidden">GovInsight-AI</h1>
              <p className="text-xs text-slate-400 hidden md:block">Intelligent Quality Inspection System for Government Service Hotline Work Orders</p>
            </div>
          </div>
          <button
