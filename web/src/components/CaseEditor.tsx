...
export const CaseEditor: React.FC<CaseEditorProps> = ({ input, onChange }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Transcript Editor */}
      <div className="bg-white rounded-lg border border-purple-200 shadow-sm overflow-hidden ring-2 ring-purple-50">
        ...
        <div className="p-4">
          <textarea
            ...
            className="w-full text-sm leading-relaxed text-gray-700 p-4 bg-gray-50 rounded-lg border border-gray-200 min-h-[300px] font-mono focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none resize-y"
